...
export default function Themes() {
  const time = useCountdown('2026-04-19T10:00:00')
  ...
  return (
    <section id="themes" className="relative z-[1]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-[5%] py-16 sm:py-20 text-center">
        ...
        >
          <p className="font-mono text-[0.62rem] sm:text-xs text-red-400 tracking-[1.5px] sm:tracking-[2px] mb-4 uppercase">Problem statements release on Apr 19 at 10:00 AM</p>
